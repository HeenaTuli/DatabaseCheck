...
mysql -h testcodeship.c3pmyiqsuzhg.us-east-1.rds.amazonaws.com -P 3306 -u admin -pCodeship < /home/rof/src/github.com/HeenaTuli/DatabaseCheck/createtable.sql;
exit(); 
exit 
